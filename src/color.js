const ParsedColor = require('color');
...
module.exports = class Color {
    ...
    get luminosity(){
        return (0.2126 * this._red + 0.7152 * this._green + 0.0722 * this._blue) / 255;
    }
    ...
    contrast(){
        return this.luminosity > 0.6 ? new Color(0, 0, 0, 1) : new Color(255, 255, 255, 1);
    }
}
